...
## 2026-06-09 — Voidascend: První nepřítel Harvester

- Mise na Glaciusu teď místo generických nepřátel posílají roje Harvesterů, kteří se drží v malých skupinách, manévrují po bojišti a střílí slabší projektily na hráče nebo decoy.
- Harvester má nový PixelLab sprite s ledově modrou broučí siluetou; pozdější vlny si zachovávají vzácnějšího nosiče krystalů jako odolnější zbarvenou variantu roje.
- Harvester roje nově sledují hráče z bezpečného odstupu místo náhodného bloudění a sprite brouka se natáčí podle aktuálního směru pohybu.
- Harvester má novou PixelLab movement animaci se střídáním nohou a jemným pohybem těla, která se přehrává při letu roje.
- Harvester je v misi větší a začne sledovat hráče hned po vstupu na obrazovku.
- Harvester roje mohou do mise přiletět z horní, dolní, levé i pravé strany obrazovky.
- Harvester roje se po vstupu na obrazovku drží celým tělem ve viditelné ploše a přepnou se do sledování i při těsném dosažení okrajového vstupního bodu, takže se nepřichytávají k okrajům.

---

## 2026-06-09 — Voidascend: Výraznější suroviny

- Kovový šrot a void krystaly mají znovu vygenerované PixelLab pickup obrázky s jasnějším svitem a větší dominantní siluetou.
- Suroviny se v misích vykreslují dvojnásobně větší, takže jasnější assety lépe vystoupí z pozadí bojiště.

---

## 2026-06-09 — Voidascend: Animované exploze projektilů

- Hráčské projektily při zásahu nepřítele nově spouští krátkou PixelLab explozi místo okamžitého zmizení bez dopadového efektu.
- Exploze mají malou, střední a velkou variantu, takže obyčejné střely, naváděné rakety a silnější projektily působí rozdílně.

---

## 2026-06-09 — Voidascend: Plynulejší odinstalování modulů

- Odinstalační zóna v pravé části hangáru při přetažení modulu z lodi plynule nabíhá a mizí místo okamžitého přepnutí.

---

## 2026-06-09 — Voidascend: PixelLab assety nových modulů

- Novější moduly bez vlastních obrázků mají nové PixelLab ikony: dvojitý raketomet, výbušné rakety, target marker, duplikátor, nové sběrače, Decoy a orbitální bombardování.
- Tyto moduly mají připravené osmisnímkové idle animace, takže v hangáru, obchodě a na lodi mohou jemně pulzovat nebo signalizovat aktivní technologii.

---

## 2026-06-09 — Voidascend: Volnější pohyb nepřátel

- Nepřátelé po vstupu do mise už nepatrolují jen vodorovně; průběžně si vybírají nové cíle po obrazovce a létají k nim různými rychlostmi.
- Pohyb nepřátel je ohraničený aktuální velikostí obrazovky, takže se drží uvnitř bojové plochy i po změně rozlišení.

---

## 2026-06-07 — Voidascend: Raketomet 1

- Modul Rakety je přejmenovaný na Raketomet 1 a zůstává naváděnou raketovou zbraní.
- Raketomet 1 nově vystřeluje jen jednu naváděnou raketu.
- Nový Raketomet 2 vystřeluje dvě naváděné rakety současně.
- Nové moduly Výbušná raketa 1 a Výbušná raketa 2 fungují jako jedno- a dvojraketová naváděná zbraň, ale při prvním zásahu vypustí krátké šrapnely, které mají šanci udělit okolním nepřátelům malé poškození.
- Šrapnely výbušných raket teď mají trojnásobný dosah a rozlétají se nepravidelně dokola s drobnými zpožděními, takže výbuch působí přirozeněji.
- Výbuch výbušných raket se znovu spolehlivě zobrazuje jako samostatný efekt s okamžitým zábleskem a postupně vykreslenými šrapnely.
- Načítání efektu výbušných raket už nepadá na parseru kvůli statickému typu šrapnelového efektu.
- Nový modul Duplikátor zdvojí každý hráčský projektil, který přes jeho slot přeletí; kopie zachová typ střely včetně navádění a výbušnosti.

---

## 2026-06-07 — Voidascend: Sběrače

- Nový Pokročilý sběrač 2 funguje jako Pokročilý sběrač 1, ale vysílá dvě sběrací lodě, které mohou současně létat pro materiál.
- Všechny sběrače teď pohybují paží nebo sběrací lodí poloviční rychlostí, takže sběr materiálu působí pomaleji a čitelněji.

---

## 2026-06-07 — Voidascend: Decoy modul mezi aktivními schopnostmi

- Decoy modul je nově zařazený mezi aktivní schopnosti místo štítů, takže se v obchodě a modulech filtruje pod kategorií Aktivní.
- Funkce decoye zůstává stejná: klávesa G vytvoří holografickou kopii lodi a schopnost dál používá vlastní cooldown.

---

## 2026-06-06 — Voidascend: Sběrače
...
- Nový Pokročilý sběrač 1 místo mechanické paže vypouští malou sběrací loď, která doletí pro materiál, přiveze ho k nákladovému prostoru a má dvojnásobný dosah oproti Základnímu sběrači 1; loď létá po jemném oblouku se zrychlením a brzděním.
- Dosah všech sběračů je zdvojnásobený, takže materiál začnou zachytávat z větší vzdálenosti.
- Sběr znovu vyžaduje nákladový prostor; samotný sběrač bez cargo modulu materiál neuloží.
...
## 2026-06-02 — Voidascend: PixelLab hlavní navigace

- Spodní navigace v základně má nové PixelLab ikony pro Hangár, Obchod, Mise a Tester místo emoji prefixů.
- Tlačítka hlavních herních sekcí zůstávají textově čitelná, ale vizuálně víc ladí se sci-fi assety hry.

## 2026-06-02 — Voidascend: Větší hitbox lodi

- Hráčská loď má větší gameplay hitbox, takže nepřátelské střely a kontaktní poškození lépe odpovídají viditelné velikosti lodi v misi.

## 2026-06-02 — Voidascend: Horizontální patrol nepřátel

- Nepřátelé po hlubším vstupu do obrazovky přestanou klesat a začnou patrolovat do stran s odrazem od okrajů, takže zůstávají v bojišti místo odlétání dolů.
- Každý nepřítel si při spawnu zvolí trochu jinou výšku patrolu, aby řady nepůsobily úplně stejně.
- Vlny teď posílají víc nepřátel, takže bojová část je hustší a méně prázdná.

## 2026-06-02 — Voidascend: PixelLab suroviny

- Kovový šrot a void krystaly mají nové PixelLab pickup obrázky s průhledným pozadím, čitelnějšími tvary a výraznějším sci-fi vzhledem v misi.
- HUD, základna a obchod používají stejné PNG ikony místo emoji pro resource countery, odměny a ceny.
- Procedurální generátor assetů už tyto pickupy nepřepisuje a použije fallback jen při chybějících souborech.
