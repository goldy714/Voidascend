...
## 2026-05-25 — Voidascend: Přesun AI instrukcí do AGENTS.md

- Přidán kořenový `AGENTS.md` jako stabilní místo pro instrukce AI agentům.
- `coordination.md` zůstává určený pro průběžný stav práce a nově pouze odkazuje na `AGENTS.md`.
- Důvod: oddělit trvalá pracovní pravidla od přepisovaného koordinačního stavu.
